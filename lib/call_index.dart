...
var callIndex = [
  ...
  // Weeks 1 and 2
  CallEntry('<anything> to a Wave','e','c1/anything_to_a_wave',c1.AnythingToAWave,),
  CallEntry('Cast a Shadow','e','a1/cast_a_shadow',a1.CastAShadow,'a1/cast_a_shadow.mp3'),
  CallEntry('Chain Reaction','e','c1/chain_reaction',c1.ChainReaction,),
  CallEntry('Circulate','e','c1/circulate',c1.Circulate,),
  CallEntry('Cross Over Circulate','e','c1/cross_over_circulate',c1.CrossOverCirculate,),
  CallEntry('Cut the Interlocked Diamond','e','c1/interlocked_diamond_circulate',c1.InterlockedDiamondCirculate,),
  CallEntry('Flip the Interlocked Diamond','e','c1/interlocked_diamond_circulate',c1.InterlockedDiamondCirculate,),
  CallEntry('Interlocked Diamond Circulate','e','c1/interlocked_diamond_circulate',c1.InterlockedDiamondCirculate,),
  CallEntry('Switch to an Interlocked Diamond','e','c1/switch_to_an_interlocked_diamond',c1.SwitchToAnInterlockedDiamond,),
  CallEntry('Rotary Spin','e','c1/rotary_spin',c1.RotarySpin,),
  CallEntry('Split Counter Rotate','e','c1/split_counter_rotate',c1.SplitCounterRotate,),
  CallEntry('Step and Flip','e','c1/step_and_flip',c1.StepAndFlip,),
  CallEntry('Step and Fold','e','c1/step_and_fold',c1.StepAndFold,),
  CallEntry('Switch the Line','e','c1/switch_the_line',c1.SwitchTheLine,),
  CallEntry('Switch to a Diamond','e','c1/switch_to_a_diamond',c1.SwitchToADiamond,),
  CallEntry('Switch to an Hourglass','e','c1/switch_to_an_hourglass',c1.SwitchToAnHourglass,),
  CallEntry('Track (0,1,2,3,4)','e','c1/track_n',c1.TrackN,),
  CallEntry('Square Chain the Top','e','c1/square_chain_the_top',c1.SquareChainTheTop,),
  CallEntry('Split Square Chain the Top','e','c1/split_square_thru_variations',c1.SplitSquareThruVariations,),
  CallEntry('Three by Two Acey Deucey','e','c1/three_by_two_acey_deucey',c1.ThreeByTwoAceyDeucey,),
  CallEntry('Counter Rotate','e','c1/counter_rotate',c1.CounterRotate,),
  CallEntry('Cross By','e','c1/cross_by',c1.CrossBy,),
  CallEntry('Galaxy Circulate','e','c1/galaxy_formation',c1.GalaxyFormation,),
  CallEntry('Galaxy Formation','e','c1/galaxy_formation',c1.GalaxyFormation,),
  CallEntry('Flip the Galaxy','e','c1/galaxy_formation',c1.GalaxyFormation,),
  CallEntry('Cut the Galaxy','e','c1/galaxy_formation',c1.GalaxyFormation,),
  CallEntry('Shakedown','e','c1/shakedown',c1.Shakedown,),
  CallEntry('Tally Ho','e','c1/tally_ho',c1.TallyHo,),
  CallEntry('Tandem Concept','e','c1/tandem_concept',c1.TandemConcept,),
  CallEntry('Follow Thru','e','c1/follow_thru',c1.FollowThru,),
  CallEntry('Relay the Top','e','c1/relay_the_top',c1.RelayTheTop,),
  CallEntry('Triangle Circulate','e','c1/triangle_formation',c1.TriangleFormation,),
  CallEntry('With the Flow','e','c1/with_the_flow',c1.WithTheFlow,),
  CallEntry('Swing the Fractions','e','c1/swing_the_fractions',c1.SwingTheFractions,),
  CallEntry('Rotate','e','c1/rotate',c1.Rotate,),
  CallEntry('Single Rotate','e','c1/rotate',c1.Rotate,),
  CallEntry('Reverse Rotate','e','c1/rotate',c1.Rotate,),
  CallEntry('Reverse Single Rotate','e','c1/rotate',c1.Rotate,),

  // Week 3
  CallEntry('Little','e','c1/scoot_and_little',c1.ScootAndLittle,),
  CallEntry('Scoot and Little','e','c1/scoot_and_little',c1.ScootAndLittle,),
  CallEntry('Cross Extend','e','c1/cross_extend',c1.CrossExtend,),
  CallEntry('Siamese Concept','e','c1/siamese_concept',c1.SiameseConcept,),
  CallEntry('Split Dixie Style to a Wave','e','c1/split_square_thru_variations',c1.SplitSquareThruVariations,),
  CallEntry('Vertical Tag','e','c1/vertical_tag',c1.VerticalTag,),
  CallEntry('But','e','c1/but',c1.But,),
  CallEntry('Jaywalk','e','c1/jaywalk',c1.Jaywalk,),
  CallEntry('Square the Bases','e','c1/square_the_bases',c1.SquareTheBases,),
  CallEntry('Triple Box / Column / Line / Wave Concept','e','c1/triple_box_concept',c1.TripleBoxConcept,),
